...
QT_MOC_LITERAL(1, 6, 7), // "sendSel"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 29) // "on_pushButton_Enter_onclicked"

    },
    "Input\0sendSel\0\0on_pushButton_Enter_onclicked"
};
...
void Input::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSel((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Input::sendSel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Input::sendSel(QString _t1)
{
