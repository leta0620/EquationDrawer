...
QT_MOC_LITERAL(1, 6, 9), // "sendInput"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 29) // "on_pushButton_Enter_onclicked"

    },
    "Input\0sendInput\0\0on_pushButton_Enter_onclicked"
};
...
void Input::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendInput((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_Enter_onclicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Input::sendInput)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Input::sendInput(QString _t1)
{
